...
class FunctionalTests(unittest.TestCase):
    ...
    def test_get_object_info_not_found(self):
        ...
        res = self.testapp.get(
            ...
            "/TEST_CONTAINER_ID/not_found/meta",
            expect_errors=True,
        )
        self.assertEqual("404 Not Found", res.status)
        res2 = self.testapp.get(
            "/collections/TEST_COLLECTION/containers"
            "/TEST_CONTAINER_NOT_FOUND/not_found/meta",
            expect_errors=True,
        )
    ...
    def test_update_object_validation_failure(self):
        ...
        self.assertDictEqual(
            {"message": "Failed validation: The object key must be 3 characters long"},
            res.json_body,
        )
    ...
    def test_copy_object_invalid_body_not_found(self):
        ...
        self.assertIn(
            "Container - object (TEST_CONTAINER_ID - 200) combination "
            "was not found in Collection TEST_COLLECTION",
            res2.text,
        )
    ...
    def test_update_file_in_zip(self):
        ...
        res = self.testapp.put(
            "/collections/TEST_COLLECTION/containers/" "TEST_CONTAINER_ID/002/lol.jpg",
            new_file,
            expect_errors=True,
        )
        self.assertEqual(res.status_code, 400)
    ...
    def test_get_objects_as_zip(self):
        ...
        res = self.testapp.get(
            "/collections/TEST_COLLECTION/containers"
            "/TEST_CONTAINER_ID?001=custom_name.jpg",
            headers=zip_header,
        )
        self.assertEqual("200 OK", res.status)
        zip_file = io.BytesIO(res.body)
